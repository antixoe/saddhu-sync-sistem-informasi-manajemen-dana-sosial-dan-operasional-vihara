...
@section('header', 'Record Petty Cash Transaction')
@section('subtitle', 'Log a small daily expense')
    ...
    <div class="card-spiritual p-8">
        <form action="{{ route('petty-cash.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex space-x-4 pt-6 border-t border-gray-200">
                ...
                <a href="{{ route('petty-cash.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50">
                    Cancel
                </a>
            </div>
        </form>
