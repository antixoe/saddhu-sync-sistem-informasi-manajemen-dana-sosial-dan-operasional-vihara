            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="password" class="block text-sm font-semibold text-deep-brown mb-2">
                        <i class="fas fa-lock text-saffron"></i> Change Password (Leave blank to keep current)
                    </label>
                    ...
                    <p class="text-xs text-gray-600 mt-1">
                        <i class="fas fa-info-circle"></i> Generate a new password if the member forgot theirs
                    </p>
                    @error('password')
