    ...
    <div>
        <div class="card-spiritual p-6 mb-6">
            ...
            <div class="space-y-2">
                ...
                <form action="{{ route('rituals.destroy', $ritual) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this ritual/event? This action cannot be undone.');" class="mt-2">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="block w-full px-4 py-2 bg-red-600 text-white rounded-lg text-center text-sm font-medium hover:bg-red-700">
